...
case $category_choice in
    ...
    2)
        ...
        ;;
    3)
        endpoints="/load_balancer/frontend_nlb_tcp_network_throughput /load_balancer/frontend_nlb_udp_network_throughput /load_balancer/frontend_firewall_dropped_bytes /load_balancer/frontend_firewall_dropped_packets"
        ;;
    *)
